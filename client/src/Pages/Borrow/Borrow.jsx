...
const allUrl =  import.meta.env.VITE_API_URL + "/borrowed"
const url = `${import.meta.env.VITE_API_URL}/borrowed?email=${user?.email}`
useEffect(()=>{
  {  isAdmin
    ? 
    fetch(allUrl)
...
const handleRemove = (id) =>{
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`${import.meta.env.VITE_API_URL}/borrowed/${id}`,
      {method: "DELETE"})
      .then(res=> res.json())
      .then(data => {
        console.log(data);
...
const handleIncrease = (id)=>{
 ...
 // send decreased quantity to the server
  fetch(`${import.meta.env.VITE_API_URL}/books/${selectedBook?._id}`,{
    method: "PATCH",
    headers: {
...
//  // send decreased quantity to the server
// //   fetch(`${import.meta.env.VITE_API_URL}/books/${book?._id}`,{
// //     method: "PATCH",
// //     headers: {
// //       "content-type":"application/json"
// //     },
