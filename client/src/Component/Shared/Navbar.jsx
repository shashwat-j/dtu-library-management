...
<NavLink className={({isActive})=> isActive ? "text-sm md:text-md lg:text-xl font-bold text-white bg-gradient-to-r from-purple-700 to-blue-400 px-3 py-2 duration-300 rounded-lg" : "px-3 py-2 text-sm md:text-md lg:text-xl font-bold text-blue-400 hover:underline"} to='/library-dashboard'><li>Dashboard</li></NavLink>
</div>   

    return (
<div className="navbar px-[5px] md:px-[50px] lg:px-[40px] flex lg:py-5 items-center">
  <div className="navbar-start">
    ...
    <div className="title flex items-center gap-2">
     ...
     <h1 className='text-3xl font-semibold'>DTU Library</h1>
    </div>
  </div>
  ...
  ? 
    <div className="dropdown dropdown-end flex items-center text-gray-600">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-[300px] z-30 p-2 shadow bg-base-100 rounded-box w-[350px]">
            ...
            <li className='w-full'><NavLink to='/borrowed' className="btn bg-gradient-to-r from-purple-700 to-blue-300 text-white text-center pt-3 w-full text-xl"><p>Borrowed Books</p></NavLink></li>
